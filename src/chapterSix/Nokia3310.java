...
public class Nokia3310 {
    ...
    private static void returnToMainMenu(int main)
    {
        switch (main)
        {
            case (1):
    ...
    private static void phoneBook(int phoneBookMenu) {
        ...
        private static void tone(int tone)
    {
    ...
    private static void clock(int clock)
    {
    ...
    private static void callRegister(int callRegister)
    {
    ...
    private static void settings(int setting)
    {
    ...
    private static int menu(int userChoiceMainMenu)
    {
        System.out.println();
        ...
        userChoiceMainMenu= userInput.nextInt();
    ...
    public static void main(String[] args)
        {
            ...
            System.out.println(" ");
            System.out.println("----- Press Numbers for Menu! ----> ");
